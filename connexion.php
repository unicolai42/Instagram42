        ...
        <div id="wrapper">
            <div id="bloc">
                <div id="box">
                    ...
                    <form action="backend/check_connexion.php" method="post">
            ...
            <div id='hors_block'>
                <a id="signup" href="inscription.php">Not a member yet ? <span id="inscription">Create your account</span></a>
                <div id="frame_error">
                    <div id="absolute_error">
                    <?PHP
                        if (!empty($_SESSION['error']) && $_SESSION['error'] == 'wrong pwd' && !empty($_SESSION['username']))
                            echo '<a class="error" href="backend/forget_pwd.php">Send back my password by mail</a>';
                        else if (!empty($_SESSION['error']) && $_SESSION['error'] == 'unactivate' && !empty($_SESSION['username']))
                            echo '<a class="error" href="/backend/resend_activate_mail.php">Send back the activation mail</a>';
