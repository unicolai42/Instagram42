...
function put_profil_picture_in_db(img) {
    ...
    request.open('POST', 'backend/check_profil_picture.php', true);
...
function hover_box() {
    ...
    request.open('POST', 'backend/select_nb_likes_and_comments_posts.php', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function delete_post_index(elem) {
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/delete_post.php', true);
    request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
...
function like_or_dislike_post(elem) {
    ...
    else
    {
        ...
        {
            var request = new XMLHttpRequest();
            request.open('POST', 'backend/like_post.php', true);
            request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        ...
        {
            var request = new XMLHttpRequest();
            request.open('POST', 'backend/dislike_post.php', true);
            request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
...
function delete_comment(elem){
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/delete_comment.php', true);
    request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
...
function new_comment(e) {
    ...
    if (key === 13) {
        ...
        var request = new XMLHttpRequest();
        request.open("POST", "backend/check_comment.php", true);
        request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function start_and_stop_follow(e, following_id) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/start_and_stop_follow.php', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
{
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/recover_img.php', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    request.send('user_id=' + user_id);
    request.onreadystatechange = function ()
    {
...
function search() {
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/recover_users.php', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    request.send();
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200)
...
function expand_post(post, post_id) {
    var request = new XMLHttpRequest();
    request.open('POST', 'backend/black_opacity_box_profil.php', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    request.send('post_id=' + post_id);
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200)
...
function click_notif(notif) {
    notif.addEventListener('click', function(e) {
        var request = new XMLHttpRequest();
        request.open('POST', 'backend/push_notif_as_read.php', true);
        request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function notif() {
    document.getElementById('like_notif').addEventListener('click', function(e) {
        var request = new XMLHttpRequest();
        request.open('POST', 'backend/recover_notif.php', true);
        request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        request.send();
        request.onreadystatechange = function() {
            if (request.readyState == 4 && request.status == 200)
